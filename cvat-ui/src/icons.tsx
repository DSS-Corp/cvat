...
import SVGHighGround from './assets/hg-logo.svg';
import SVGHighGroundSm from './assets/hg-logo-sm.svg';
...
export const HGLogoIcon = React.memo((): JSX.Element => <SVGHighGround />);
export const HGLogoSmIcon = React.memo((): JSX.Element => <SVGHighGroundSm />);
